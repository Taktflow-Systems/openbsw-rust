//! Minimal blink + UART hello + CAN loopback for NUCLEO-G474RE.
//!
//! Build: `cargo build --features stm32g474 --target thumbv7em-none-eabihf --example blink_g474`
...
/// Register base addresses (STM32G474).
...
fn main() -> ! {
    ...
    // 1. Configure clocks (170 MHz boost mode)
    ...
    uart.init();
    let _ = writeln!(uart, "Hello from Rust BSP on STM32G474RE @ {} MHz", sys_clock / 1_000_000);
